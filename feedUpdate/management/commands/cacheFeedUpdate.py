...
class Command(BaseCommand):
    ...
    def process_feed(current_feed):
        ...
        print("1 parsed: ", 1000*(time.time() - cycle_time))
        feedUpdate_list = reversed(feedUpdate_list)
        print("2 reversed: ", 1000*(time.time() - cycle_time))
        ...
        print("3 checked: ", 1000*(time.time() - cycle_time))
        ...
        for each in feedUpdate_list:
            ...
            if not cached:
                ...
                each.save()
                cycle_items += 1
        print("4 saved: ", 1000*(time.time() - cycle_time))
